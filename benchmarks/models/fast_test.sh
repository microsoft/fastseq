...
./benchmark.sh transformers+fastseq sshleifer/distilbart-cnn-12-6 cnn_dm.128/raw val 64/128 --task summarization
./benchmark.sh transformers sshleifer/distilbart-cnn-12-6 cnn_dm.128/raw val 64 --task summarization
