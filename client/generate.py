...
# This script comes from https://github.com/pytorch/fairseq/blob/master/fairseq_cli/generate.py.
# The difference is that `fastseq` is imported by default. If the supported
# version of `fairseq` is installed, the optimizations provided by `fastseq`
