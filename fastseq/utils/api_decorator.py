...
def get_class(method):
    """Get the class of the input method.

    Args:
        method (object): an unbound method or function. 

    Returns:
        A class of the input method. It will be `None` if the input
...
def replace(target_obj):
    ...
    Args:
        target_obj (class/func/method): a class, method, or function to be replaced.
